<template>
    ...
    <div class="w3-container" align="center">
        <br/><br/>
        <h2 class="w3-center">Información personal del empleado <span> {{employeeDetailById.name}}</span></h2>
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest" align="left">
            <label>Correo electrónico:  &nbsp</label>        
